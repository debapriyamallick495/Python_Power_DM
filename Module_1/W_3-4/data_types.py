#create array with different data types
import numpy as np
...
print(f"Integers array datatypes :{loaded['integers']}")
print(f"Float array datatypes :{loaded['floats']}")
print(f"Boolean array datatypes :{loaded['booln']}")